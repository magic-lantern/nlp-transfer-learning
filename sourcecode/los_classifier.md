...
# Train a Length of Stay classifier, no pretraining

Instead of building from a MIMIC trained language model or a pre-trained language model - just start with random weights.
...
class_file = 'los_no_ft_data.pickle'
